var setting = {
    ...
    HOST:'127.0.0.1:8888', //你要连接到的服务器IP或域名，如果BingAI服务器端口不为80，请在后面加上":端口值"。默认为127.0.0.1，即为访问本地服务器。
    ...
    tips:"主人，私のお気に入り(◍•ᴗ•◍)，尽情吩咐我吧(⸝⸝•‧̫•⸝⸝),しかし不可以瑟瑟哦，不可以できない·", //在新的主题开始时的第一条对话前插入的提示，null和空的英文双引号（""）表示没有。
